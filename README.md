...
* A **landing page** containing:
  ...
  * Links to each visualizations page. Featuring a sidebar containing preview images of each plot, while clicking an image takes the user to that visualization.
